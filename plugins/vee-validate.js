...
import { required, max, email, min, numeric, between } from 'vee-validate/dist/rules' // 使用するバリデーションルール
...
extend('numeric', numeric) // 数値のバリデーション
extend('between', between) // 数値範囲のバリデーション
